...
final class ExpressionPathGenerator implements Generator
{
    ...
    private static function parseVariable(string $variable, ?string $arguments, Node $node, array $context): string // @phpstan-ignore missingType.iterableValue
    {
    ...
    private static function parseVariableValue(string $variable, array $arguments, array $context): mixed // @phpstan-ignore missingType.iterableValue, missingType.iterableValue
    {
    ...
    private static function parseChecksum(File $file, array $parts): string // @phpstan-ignore missingType.iterableValue
    {
     ...
     */
    private static function dotAccess(object|array &$what, string $path, array $arguments): mixed // @phpstan-ignore missingType.iterableValue, missingType.iterableValue
    {
        $current = &$what;

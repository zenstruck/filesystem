 ...
 */
final class UnableToMoveDirectory extends \RuntimeException implements FilesystemOperationFailed
{
    ...
    {
        return new self($source, $destination, \sprintf('Unable to move directory from "%s" to "%s". %s', $source, $destination, $reason), $previous);
    }
